    ...
    @if ($comparisons > 0 || $moves > 0)
        <div class="grid grid-cols-3 gap-3">
            ...
            <div class="p-3 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
                <div class="text-xs font-medium text-purple-600 dark:text-purple-400">Movimentações</div>
                <div class="text-xl font-bold text-purple-900 dark:text-purple-100">{{ $moves }}</div>
            </div>
