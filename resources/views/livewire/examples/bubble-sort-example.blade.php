    ...
    @if ($comparisons > 0 || $swaps > 0)
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div class="p-3 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg">
                <div class="text-xs font-medium text-indigo-600 dark:text-indigo-400">Passadas</div>
                <div class="text-xl font-bold text-indigo-900 dark:text-indigo-100">{{ $passes }}</div>
            </div>
